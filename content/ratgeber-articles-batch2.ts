    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "**Baurecht in NRW:** Bei **Sonderbauten** nach § 50 BauO NRW kann ein BSB im **Brandschutzkonzept** oder in der **Baugenehmigung** als Auflage stehen. Zusätzlich regelt die SBauVO **eigene Bestellpflichten** für Verkaufsstätten Teil 3 und Hochhäuser – unabhängig von DGUV: [BSB-Pflicht nach SBauVO](/ratgeber/brandschutzbeauftragter-pflicht-sbauvo-nrw).",
