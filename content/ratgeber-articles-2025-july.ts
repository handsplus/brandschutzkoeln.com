/**
 * Juli 2025 – 4 Artikel (Qualitätsrhythmus: 4/Monat).
...
export const RATGEBER_ARTICLES_2025_JULY: RatgeberArticle[] = [
  {
    ...
    title: "Elektrische Betriebsräume: SBauVO Teil 6 und Batterieräume",
    excerpt:
    ...
    metaTitle: "Elektrische Betriebsräume SBauVO | H&S+",
    metaDescription:
      "Elektrischer Betriebsraum NRW: §143–149 SBauVO, Transformator, Batterieraum, feuerbeständig, Mineralöl – Planung Technikgebäude und Sonderbau.",
    keywords: [
      "Elektrischer Betriebsraum",
      "SBauVO Teil 6",
      "Batterieraum Brandschutz",
      "Transformatorraum",
      "USV Raum Brandschutz",
      "Technikraum NRW",
    ],
    sections: [
      {
        id: "einordnung",
        title: "Warum Technik nicht im Flur stehen darf",
        paragraphs: [
          ...
          "Grenzfall ja: Neubau Gewerbe mit 20-kV-Station, feuerbeständiger Raumabschluss, Ausgang ins Freie, Ölauffang unter Transformatoren, keine Fremdleitungen im Raum. Grenzfall nein: USV und Verteiler im Flur neben Rettungsweg – weder § 143 noch [Technikgebäude](/ratgeber/technische-betriebsgebaeude-brandschutz-nrw)-Logik erfüllt.",
        ],
      },
      {
        id: "anlagen",
      ...
      {
        id: "raum",
        title: "Anforderungen an den Betriebsraum",
        paragraphs: [
          ...
          "Schnittstelle [Batteriespeicher Li-Ion](/ratgeber/batteriespeicher-lithium-ionen-brandgefahren): § 149 Batterieräume betrifft zentrale sicherheitstechnische Batterieanlagen – nicht jeden Gewerbe-Li-Ion-Speicher; dennoch parallel Gefährdungsbeurteilung.",
        ],
      },
      {
        id: "ausnahmen",
        title: "Wann kein eigener Betriebsraum nötig ist",
        paragraphs: [
          ...
          "Umbau Bestand: neue PV-Wechselrichter-Gruppe oder Batteriespeicher im Technikraum kann Nachweis-Pflicht auslösen – [Umbau](/ratgeber/umbau-nutzungsaenderung-brandschutz).",
        ],
      },
      {
        id: "nachweis",
        title: "Genehmigung und Konzept",
        paragraphs: [
          "In Sonderbauten und genehmigungspflichtigen Vorhaben: Lage und Ausbildung elektrischer Betriebsräume im [Brandschutzkonzept](/ratgeber/brandschutzkonzept-baupruefvo-nrw) – Haustechnik an Rettungswegen, Sicherheitsstromversorgung.",
          ...
          "[Technische Betriebsgebäude](/ratgeber/technische-betriebsgebaeude-brandschutz-nrw) für freistehende Technikbauten ergänzend.",
        ],
      },
      {
        id: "hinweis",
    ...
    relatedLinks: [
      ...
      { href: "/ratgeber/hochhaus-brandschutz-sbauvo-nrw", label: "Hochhaus Technik" },
    ...
    faq: [
      ...
      {
        question: "Was ist ein Batterieraum nach § 149?",
        answer:
      ...
      {
        question: "Warum Ölauffang unter dem Transformator?",
        answer:
      ...
      {
        question: "Dürfen Kabel fremder Anlagen im Traforaum liegen?",
        answer:
